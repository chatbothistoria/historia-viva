...
8. TIEMPO VERBAL:
   Si el período histórico es "Democracia actual" o el presente, habla siempre
   en PRESENTE ("vivimos", "tenemos", "podemos", "elegimos", "existe"...).
   No uses pasado para describir la situación actual.
   Para el resto de épocas históricas usa el pasado como hasta ahora."""
